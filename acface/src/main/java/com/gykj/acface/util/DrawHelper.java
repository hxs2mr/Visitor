...
public class DrawHelper {
    ...
    public static void drawFaceRect(Canvas canvas, DrawInfo drawInfo, int color, int faceRectThickness) {
        ...
        Path mPath = new Path();
        //左上
        mPath.moveTo(rect.left, rect.top + rect.height());
        mPath.lineTo(rect.left, rect.top);
        mPath.lineTo(rect.left + rect.width(), rect.top);
        //右上
        mPath.moveTo(rect.right - rect.width(), rect.top);
        mPath.lineTo(rect.right, rect.top);
        mPath.lineTo(rect.right, rect.top + rect.height());
        //右下
        mPath.moveTo(rect.right, rect.bottom - rect.height());
        mPath.lineTo(rect.right, rect.bottom);
        mPath.lineTo(rect.right - rect.width(), rect.bottom);
        //左下
        mPath.moveTo(rect.left + rect.width(), rect.bottom);
        mPath.lineTo(rect.left, rect.bottom);
        mPath.lineTo(rect.left, rect.bottom - rect.height());
